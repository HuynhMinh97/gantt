...
@ObjectType()
export class DataMasterResponse {
    @Field(() => [DataMasterEntity], { nullable: true })
    data?: DataMasterEntity[];
    ...
    constructor(status: number, result: DataMasterEntity[], message: string) {
        this.status = status;
        switch (status) {
